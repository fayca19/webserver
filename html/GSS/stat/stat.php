...
?>
	...
	<div class="container">
		...
		<script>
		function createConfig(gridlines, title,latoui,amour,arab,zefouni,zemrani,bouchama,mansouri,bouter,bouaziz,mesli,haddar,bachir,maxi,step) {
			return {
				type: 'line',
				data: {
		...
		window.onload = function() {
			...
			[{
				...
				var config = createConfig(details.gridLines, details.title,<?php echo $latoui; ?>,<?php echo $amour; ?>,<?php echo $arab; ?>,<?php echo $zefouni; ?>,<?php echo $zemrani; ?>,<?php echo $bouchama; ?>,<?php echo $mansouri; ?>,<?php echo $bouter; ?>,<?php echo $bouaziz; ?>,<?php echo $mesli; ?>,<?php echo $haddar; ?>,<?php echo $bachir; ?>,<?php echo $max; ?>,<?php echo $step; ?>);
