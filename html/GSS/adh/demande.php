...
<div id="page-heading"><h1>Demande de Prise en charge (Assure-Principal)</h1></div>
...
xhr.open("GET", "demande/insertdem.php?r0="+pol+"&r1="+user+"&r2="+adr+"&r3="+act+"&r4="+datact+"&r5="+freel+"&r6="+coef, false);
xhr.send(null);
