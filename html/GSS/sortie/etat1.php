...
//sprintf
$query_demande = ($bdd->prepare("select d.*, c.*,a.* from demande as d, accprest as u, polices as p, actes as c, adherents as a where d.id_user=u.id_user and d.id_pol=p.id_pol and d.id_act=c.id_act and d.id_adr=a.id_adr and  d.date_dem >= $dated and d.date_dem <= $datef and d.et_dem=$etat and d.id_user=$id_user"));
