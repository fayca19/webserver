...
$pdf->Cell(190,8,'Facture Tiers-Payant','0','0','C');$pdf->Ln();
$pdf->Cell(190,8,'N°: '.str_pad((int) $r0,'7',"0",STR_PAD_LEFT).'','0','0','C');$pdf->Ln();$pdf->Ln();
...
$pdf->Cell(25,5,"MTT-A-Lettre",'1','0','C','1');$pdf->Cell(165,5,"".$somme2."",'1','0','C','1');$pdf->Ln();
$mtt=$row_dem['fr_dem']-$row_dem['mtt_remb'];
$net=$a1->ConvNumberLetter("".$mtt."",1,0);$pdf->SetFont('Arial','B',10);
$pdf->Cell(25,5,"",'0','0','L','1');$pdf->Cell(65,5,"Ticket-Moderateur",'1','0','C','1');
$pdf->Cell(100,5,"".number_format($mtt, 2,',',' ')."",'1','0','C','1');$pdf->Ln();
$pdf->Ln(15);

//$pdf->Cell(25,5,"T.Moderateur",'1','0','C','1');$pdf->Cell(165,5,"".number_format($mtt, 2,',',' ')."",'1','0','C','1');$pdf->Ln();
//$pdf->Cell(25,5,"TM-Lettre",'1','0','C','1');$pdf->Cell(165,5,"".$net."",'1','0','C','1');$pdf->Ln();

$pdf->SetFont('Arial','B',10);
$pdf->Cell(30,5,"Le montant à payer en lettres",'0','0','L');$pdf->Ln();
$pdf->SetFont('Arial','B',10);
$pdf->MultiCell(190,12,"".$net."",1,'C',true);
